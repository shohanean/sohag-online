...
Route::get('/deliver/the/work/{work}', [HomeController::class, 'deliver_the_work'])->name('deliver.the.work');
Route::post('/deliver/the/work/{work}', [HomeController::class, 'deliver_the_work_post'])->name('deliver.the.work.post');
