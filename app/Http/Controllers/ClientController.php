...
use App\Models\{Page, Campaign, Client_wallet, Transection, Payment, Subscription};
...
class ClientController extends Controller
{
    ...
    {
        $subscription = Subscription::with('subscription_fees')->find($subscription_id);
        if ($subscription->user_id != auth()->id()) {
            abort(404);
        }
        return view('backend.client.subscription_details', compact('subscription'));
    }
}
